...
namespace WebApp2.Controllers
{
    public class GlobalsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,eurToRON,eurToUSD")] Globals globals)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,eurToRON,eurToUSD")] Globals globals)
        {
            if (ModelState.IsValid)
            {
